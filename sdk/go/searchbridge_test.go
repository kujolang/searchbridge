...
func TestGoldenResultAndBatchDecode(t *testing.T) {
	for _, payload := range []struct {
		data string
		out  any
	}{{`{"schema":"searchbridge.result/v1","capability":"analytics","provider":"google-analytics-4","mode":"fixture","retrieved_at":"1970-01-01T00:00:00Z","rows":[]}`, &Result{}}, {`{"schema":"searchbridge.batch/v1","bounded_concurrency":2,"execution":"bounded-worker-pool","cancel_file":"","succeeded":0,"failed":0,"results":[]}`, &Batch{}}, {`{"schema":"searchbridge.multi-result/v1","capability":"serp.results","routing":{},"budget":{},"succeeded":0,"failed":0,"results":[]}`, &MultiResult{}}} {
