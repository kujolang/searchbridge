...
Research refreshed 2026-08-11 from primary documentation.
...
| Bing Webmaster | [API documentation](https://learn.microsoft.com/en-us/bingwebmaster/) supports rank/traffic, links, keywords, crawl data, URL and sitemap submission; OAuth and API key access exist. | Implemented bounded JSON REST adapters and fixtures; live endpoint behavior remains provider-account dependent. |
